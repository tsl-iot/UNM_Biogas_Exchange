...
#define HX8357_YELLOW  0x0FE0 ///< YELLOW color for drawing graphics
#define HX8357_WHITE   0xFFFF ///< WHITE color for drawing graphics
#define HX8357_ORANGE  0xFF11
#define HX8357_INDIGO  0x4B82
#define HX8357_VIOLET  0x7FFF
...
class Adafruit_HX8357 : public Adafruit_SPITFT {
  public:
    ...
    Adafruit_HX8357(int8_t _CS, int8_t _DC, int8_t _RST, uint8_t type, SPIClass *spi);
